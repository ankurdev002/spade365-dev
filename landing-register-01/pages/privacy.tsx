...
export default function Privacy() {
    return (
        <>
            <Head>
                <title>Privacy Policy | Spade365</title>
                <meta name="description" content="These terms and conditions outline the rules and regulations for the use of Spade 365 Website, located at www.Spade365.com." />
            </Head>
            <div
                className="text-black bg-white px-6 py-12 break-words prose lg:prose-xl !prose-slate w-full max-w-7xl mx-auto prose-headings:text-center"
            >
                <h1
                >
                    Privacy Policy
                ...
                <div>
                    <p>
                        ...
                        of Spade 365 Website, located at www.Spade365.com.
                    </p>
                    <p>
                        By accessing this website we assume you accept these terms and conditions.
                        Do not continue to use Spade365.com if you do not agree to take all of
                    ...
                    <p>
                        ...
                        and “Us”, refers to Spade 365. “Party”, “Parties”, or “Us”, refers to both
                    ...
                    <ul>
                        <li>
                            We employ the use of cookies. By accessing Spade365.com, you agreed to
                            use cookies in agreement with the Spade 365 Privacy Policy.
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            Unless otherwise stated, Spade 365 and/or its licensors own the
                            intellectual property rights for all material on Spade365.com. All
                            intellectual property rights are reserved. You may access this from
                            Spade365.com for your own personal use subjected to restrictions set in
                            these terms and conditions.
                        </li>
                    </ul>
                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Spade365.com</li>
                        <li>
                            Sell, rent or sub-license material from Spade365.com
                        </li>
                        <li>
                            Reproduce, duplicate or copy material from Spade365.com
                        </li>
                        <li>Redistribute content from Spade365.com</li>
                    </ul>
                    <p>
                        Parts of this website offer an opportunity for users to post and exchange
                        opinions and information in certain areas of the website. Spade 365 does
                        not filter, edit, publish or review Comments prior to their presence on
                        the website. Comments do not reflect the views and opinions of Spade 365,
                        its agents and/or affiliates. Comments reflect the views and opinions of
                        the person who post their views and opinions. To the extent permitted by
                        applicable laws, Spade 365 shall not be liable for the Comments or for any
                    ...
                    <p>
                        Spade 365 reserves the right to monitor all Comments and to remove any
                    ...
                    <ul>
                        ...
                        <li>
                            You hereby grant Spade 365 a non-exclusive license to use, reproduce,
                    ...
                    <p>
                        ...
                        hyperlink compensates the absence of Spade 365; and (d) the link is in the
                    ...
                    <p>
                        ...
                        e-mail to Spade 365. Please include your name, your organization name,
                    ...
                    <ul>
                        ...
                        <li>
                            No use of Spade 365&apos;s logo or other artwork will be allowed for linking
