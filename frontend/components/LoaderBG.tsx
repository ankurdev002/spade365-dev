...
const LoaderBG: React.FC<LoaderBGProps> = ({
    ...
    return (
        <>
            <div id={showLogo ? 'preloader' : ''} className="fixed flex flex-col justify-center items-center w-screen top-0 left-0 h-[120vh] text-white break-words bg-gradient-to-r from-primary to-secondary z-50" >
                <div className='splash-screen'>
                    ...
                    <div className='splash-inner flex items-center justify-center flex-col -mt-56 not-italic'>
                        {showLogo &&
                            <div className="animate__animated animate__fadeInDown flex items-center justify-center flex-col">
                                <Logo size="5xl" />
