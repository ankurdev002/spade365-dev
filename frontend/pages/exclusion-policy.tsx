            ...
            <div className="text-black bg-white px-6 py-12 break-words prose lg:prose-xl !prose-slate w-full max-w-7xl mx-auto prose-headings:text-center">
                ...
                <div>
                    ...
                    <p>
                        ...
                        stop. By entering into a self-exclusion agreement with the Site, you will
                        be prevented from using your Account (as defined in the terms and
                        conditions) for a specific period, as determined by you, of between 6
                        months and 5 years.
                    </p>
                    <h2>
                    ...
                    <p>
                        If at any time you should you wish to exclude yourself from use of the
                        Site (as defined in the terms and conditions), you must submit this
                        request by email to <a href="support@spade365.com">support@spade365.com</a>
                    </p>
                    <p>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            the period requested by you, or if no period is requested by you, for
                            the Minimum Period;
                        </li>
                        <li>
                            Permanently close your Customer Account if instructed to do so by you,
                            and return all funds owed to you to your nominated bank account.
                        </li>
                    </ol>
                    <h2>
                    ...
                    <p>
                        ...
                        confirm such intention in writing. If it is decided (in the Site&apos;s
                        absolute discretion) to permit you to re-open your Account/open a new
                        Account, you should be aware that a 24-hour waiting period will be imposed
                        prior to the Account being available for use.
                    </p>
                </div>
            </div>
