...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen pt-12 pb-40 overflow-hidden relative bg-blue-500">
        {/* black overlay */}
        <div className="absolute top-0 left-0 w-full h-full bg-black opacity-30"></div>
        <div className="flex flex-col items-center justify-start w-full flex-1 px-2 text-center z-10">
          {/* content */}
          <div className="mb-6">
            <h2 className="text-xl text-white/80 text-semibold mb-6 uppercase tracking-widest">Sign Up</h2>
            {/* <Logo size={"5xl"} /> */}
            <Image src={SpadeLogo} alt="Spade365" width={200} height={200} />
          </div>
          {/* signup form with name, mobile, password, confirm password */}
          <form onSubmit={(e) => signup(e)} className="max-w-2xl w-full space-y-2 bg-black/40 rounded-sm shadow-lg px-8 backdrop-blur-md py-8">
            <div className="text-white">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full text-2xl text-white bg-accent py-2 rounded-sm uppercase mb-6 mt-4 font-semibold"
                >
                  Sign up
                </button>
